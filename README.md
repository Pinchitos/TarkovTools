...
An unofficial, non-commercial community tool for planning Escape from Tarkov Kord Breach document runs.
...
Kord Breach Route Planner is an unofficial, non-commercial fan-made tool. It is not affiliated with, sponsored by, or endorsed by Battlestate Games.
